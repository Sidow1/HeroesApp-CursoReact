...
describe('Pruebas en <SearchPage />', () => {
    ...
    test('debe de mostrar a Batman y el input con el valor del queryString', () => {
        ...
        const divSearch = screen.getByLabelText('dsearch');
        // expect(divSearch.style._values).toEqual({display: 'none'});
        expect(divSearch.style.display).toBe('none');
    });

    test('debe de mostrar un eror si no se encuentra el hero (batman123)', () => {
        ...
        const btnDanger = screen.getByLabelText('alert-danger');
        expect(btnDanger.style.display).toBe('');
    });
